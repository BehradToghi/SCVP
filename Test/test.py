...
#         blueprint.set_attribute('horizontal_fov', '30') # degrees
#         blueprint.set_attribute('vertical_fov', '30') # degrees
#         blueprint.set_attribute('points_per_second', '1500')
#         blueprint.set_attribute('range', '100') # meters
#
#         # Spawn the radar
#         radar = world.spawn_actor(blueprint, carla.Transform(carla.Location(x=1.0, z=2.8)),
#                                         attach_to=self._parent)
#
...
class BasicAgent(Agent):
    ...
    def run_step(self, debug=True):
        ...
        for target_vehicle in vehicle_list:
            print(target_vehicle.get_location())
